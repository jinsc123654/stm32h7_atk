...
u8 LTDC_Clk_Set(u32 pll3n,u32 pll3m,u32 pll3r);//LTDC时钟配置
void LTDC_Layer_Window_Config(u8 layerx,u16 sx,u16 sy,u16 width,u16 height,u8 pixformat);                                //LTDC层窗口设置
